...
//     const displayResult = (prediction, isError = false) => {
//         resultText.textContent = prediction;
//         resultText.classList.remove('result-success', 'result-error');
//         resultText.classList.add(isError ? 'result-error' : 'result-success');
//     };
...
//             } else {
//                 displayResult(`Predicted Stroke: ${result.prediction}`);
//             }
//         } catch (error) {
//             console.error('Prediction error:', error);
//             displayResult('Failed to get prediction.', true);
//         } finally {
//             showLoading(false);
//         }
//     });

//     // Handle test prediction button
//     testPredictBtn.addEventListener('click', async () => {
//         showLoading(true);
//         try {
...
//                 displayResult(result.error, true);
//             } else {
//                 displayResult(`Test Prediction: ${result.prediction}`);
//                 // Optionally fill the form with test data
//                 const formInputs = predictForm.elements;
//                 for (const key in result.sample_data) {
//                     if (formInputs[key]) {
//                         formInputs[key].value = result.sample_data[key];
//                     }
//                 }
//             }
//         } catch (error) {
//             console.error('Test prediction error:', error);
//             displayResult('Failed to run test.', true);
//         } finally {
//             showLoading(false);
//         }
//     });
